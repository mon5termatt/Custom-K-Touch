...
"body{margin:0;background:#121212;color:#f2f2f2}"
"header{background:var(--o);color:#fff;padding:14px 18px;font-size:20px;font-weight:700}"
"nav{display:flex;background:#1e1e1e;border-bottom:1px solid #3a3a3a}"
"nav a{padding:12px 18px;color:#bbb;cursor:pointer;text-decoration:none}"
"nav a.on{color:var(--o);border-bottom:2px solid var(--o)}"
".tab{display:none;padding:18px;max-width:760px}.tab.on{display:block}"
".card{background:#1e1e1e;border:1px solid #3a3a3a;border-radius:10px;padding:14px;margin:10px 0}"
...
".bar{height:14px;background:#2a2a2a;border-radius:7px;overflow:hidden}.bar>i{display:block;height:100%;background:var(--o)}"
".muted{color:#9a9a9a}</style></head><body>"
